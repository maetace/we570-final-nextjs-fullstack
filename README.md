...
3. # **ชื่อระบบงาน**
    ...
    ## Thunderbolts - Directory
    Final Project for WE670 - Next.js (Fullstack)  

    ## Description
    A directory web app for Thunderbolts characters using Next.js App Router, fullstack API, and deployment via Vercel.
    - Frontend: Next.js 14 App Router
    - Backend: Next.js API Route / External Node.js (Render)
    - Data Source: Thunderbolts characters (mock or real)
